...
Namespace API
    ...
    Public Module Plugin
        ...
        ''' <remarks></remarks>
        Public Sub HandleEvent(target As Object, eventName As String, code As [Delegate])
        ...
        ''' <param name="code">事件处理委托</param>
        ''' <remarks></remarks>
        Public Sub UnhandleEvent(target As Object, eventName As String, code As [Delegate])
            Dim targetEvent = target.GetType.GetEvent(eventName)
            If targetEvent Is Nothing Then Exit Sub
