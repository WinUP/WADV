...
Namespace Extension
    Friend NotInheritable Class ExtensionForScript
        Friend Shared Function Item_New(name As String, substance As String, onCheck As Func(Of LuaResult), onRegister As Func(Of LuaResult)) As Achievement
