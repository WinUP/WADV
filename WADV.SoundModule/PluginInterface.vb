...
Namespace PluginInterface
    ...
    Public Class Initialiser : Implements IInitialise
        ...
        Public Function Initialising() As Boolean Implements IInitialise.Initialising
            ...
            ScriptAPI.RegisterInTableSync("api_media", "play", New Func(Of String, AudioCore.SoundType, Boolean, Integer, Integer)(AddressOf SoundAPI.Play))
            ...
            ScriptAPI.RegisterInTableSync("api_media", "get", New Func(Of Integer, AudioCore.Player)(AddressOf SoundAPI.Get))
